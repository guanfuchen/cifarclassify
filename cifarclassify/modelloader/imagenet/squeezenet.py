...
class Fire(nn.Module):
    ...
    # 输入是inplanes，输出是expand1x1_planes+expand3x3_planes
    # 参数是inplanes*squeeze_planes+squeeze_planes*expand1x1_planes+squeeze_planes*expand3x3_planes*9
...
if __name__ == '__main__':
    ...
    import numpy as np
    input_data = misc.imread('../../../data/EnglishCockerSpaniel_simon.jpg')
    # 按照imagenet的图像格式预处理
    ...
    print("squeezenet1_1 forward time:", end-start)
