# -*- coding: utf-8 -*-
# code is from https://github.com/tstandley/Xception-PyTorch/blob/master/xception.py
...
class Xception(nn.Module):
    ...
    def init_weights(self, pretrained=False):
        model_checkpoint_path = os.path.expanduser('~/.torch/models/xception-c0a72b38.pth.tar')
...
if __name__ == '__main__':
    ...
    # 按照imagenet的图像格式预处理
    input_data = imagenet_utils.imagenet_preprocess(input_data, height=299, width=299)
